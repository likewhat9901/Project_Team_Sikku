...
import com.edu.springboot.info.BoardDTO;
import com.edu.springboot.info.IBoardService;
...
public class MainController {
    ...
    @GetMapping("/about/yes")
    public String yesMain(Model model) {
		
		List<BoardDTO> plants = dao.selectAll();
...
//	}
	...
	public String detail(Model model, HttpServletRequest req) {
		...
		int plant_idx = Integer.parseInt(req.getParameter("plant_idx"));
		System.out.println("plant_idx: "+ plant_idx);
		
		BoardDTO plant = dao.selectOne(plant_idx);
	...
	@GetMapping("/freeBoardView.do")
	public String freeBoardView() {
		return "/boards/freeBoardView";
	}
}
