...
public class FreeController {
	...
	public String search(BoardSearchCondDTO condDTO,
	...
	@ResponseBody
	public List<Map<String, Object>> getMoreBoards(@RequestParam("page") int page, BoardSearchCondDTO condDTO,
			Model model) {
	...
	public String view(@RequestParam("boardIdx") Long boardIdx, Model model, Principal principal,
	 ...
	 * 
	 */
	public ResponseEntity<Map<String, Object>> toggleLike(@RequestParam("boardIdx") Long boardIdx,
			Principal principal) {
