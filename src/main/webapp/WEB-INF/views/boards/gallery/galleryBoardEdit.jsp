...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
	...
	<main class="board-edit">
		<form action="galleryBoardEditProc.do" method="post" enctype="multipart/form-data">
			...
			<div class="form-actions">
				...
				<button type="button" onclick= "location.href='galleryBoardView.do?boardIdx=${board.boardIdx}'">취소</button>
			</div>
		</form>
	</main>
